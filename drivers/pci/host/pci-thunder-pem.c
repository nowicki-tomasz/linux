...
DECLARE_ACPI_MCFG_FIXUP(&pci_thunder_pem_ops, "CAVIUM", "THUNDERX", 1, 4,
			PCI_MCFG_BUS_ANY);
DECLARE_ACPI_MCFG_FIXUP(&pci_thunder_pem_ops, "CAVIUM", "THUNDERX", 1, 5,
			PCI_MCFG_BUS_ANY);
DECLARE_ACPI_MCFG_FIXUP(&pci_thunder_pem_ops, "CAVIUM", "THUNDERX", 1, 6,
			PCI_MCFG_BUS_ANY);
DECLARE_ACPI_MCFG_FIXUP(&pci_thunder_pem_ops, "CAVIUM", "THUNDERX", 1, 7,
			PCI_MCFG_BUS_ANY);
DECLARE_ACPI_MCFG_FIXUP(&pci_thunder_pem_ops, "CAVIUM", "THUNDERX", 1, 8,
			PCI_MCFG_BUS_ANY);
DECLARE_ACPI_MCFG_FIXUP(&pci_thunder_pem_ops, "CAVIUM", "THUNDERX", 1, 9,
			PCI_MCFG_BUS_ANY);
DECLARE_ACPI_MCFG_FIXUP(&pci_thunder_pem_ops, "CAVIUM", "THUNDERX", 1, 14,
			PCI_MCFG_BUS_ANY);
DECLARE_ACPI_MCFG_FIXUP(&pci_thunder_pem_ops, "CAVIUM", "THUNDERX", 1, 15,
			PCI_MCFG_BUS_ANY);
DECLARE_ACPI_MCFG_FIXUP(&pci_thunder_pem_ops, "CAVIUM", "THUNDERX", 1, 16,
			PCI_MCFG_BUS_ANY);
DECLARE_ACPI_MCFG_FIXUP(&pci_thunder_pem_ops, "CAVIUM", "THUNDERX", 1, 17,
			PCI_MCFG_BUS_ANY);
DECLARE_ACPI_MCFG_FIXUP(&pci_thunder_pem_ops, "CAVIUM", "THUNDERX", 1, 18,
			PCI_MCFG_BUS_ANY);
DECLARE_ACPI_MCFG_FIXUP(&pci_thunder_pem_ops, "CAVIUM", "THUNDERX", 1, 19,
			PCI_MCFG_BUS_ANY);
#endif
