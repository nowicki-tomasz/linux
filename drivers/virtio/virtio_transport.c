 ...
 *
 * Add a request to the queue. Data written by the device, including the event
 ...
 * The descriptor conveys input and output buffers, input buffer brings
 * event info and output buffer will be a status respond to respective event.
 */
